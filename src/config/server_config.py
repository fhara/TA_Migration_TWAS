...
# This configuration was migrated on 2020-08-06 at 23:16:19 from the following location: /opt/IBM/WebSphere/AppServer/profiles/AppSrv01
...
# Properties are migrated from server was01Node01/webserver1.
...
AdminConfig.create('J2EEResourceProperty', AdminConfigVar_2, [['name', 'name'], ['type', 'java.lang.String'], ['value', 'db2']])
...
#AdminApp.install('/path/to/ThinkDemoApp.war', ["-node", NodeName, "-server", "server1", "-appname", "ThinkDemoApp.war", "-contextroot", "/demo", "-CtxRootForWebMod", [["ThinkDemoApp.war", "ThinkDemoApp.war,WEB-INF/web.xml", "/demo"]]])
AdminConfig.save()
